...
if quant_p==2:
	if n1 in ['Marshall','Lily'] and n2 in ['Marshall','Lily']:
		print('Nada melhor que um casal para dar conselhos de relacionamento.')
	elif n1 in ['Barney','Marshall'] and n2 in ['Marshall','Barney']:
	...
	if n1 in ['Barney','Robin','Marshall','Lily'] and n2 in ['Barney','Robin','Marshall','Lily'] and n3 in ['Barney','Robin','Marshall','Lily'] and n4 in ['Barney','Robin','Marshall','Lily']:
...
if 'Barney' in [n1,n2,n3,n4] and lugar=='Arena de Laser Tag':
	...
	if n1 in ['Barney','Robin','Marshall','Lily'] or n2 in ['Barney','Robin','Marshall','Lily'] or n3 in ['Barney','Robin','Marshall','Lily'] or n4 in ['Barney','Robin','Marshall','Lily']:
